...
export const BUILTIN_CHAT_MODELS: CustomModel[] = [
  ...
  {
    name: ChatModels.AMAZON_BEDROCK_CLAUDE_3_5_SONNET,
    provider: ChatModelProviders.AMAZON_BEDROCK,
    enabled: true,
    isBuiltIn: true,
  },
  {
    name: ChatModels.AMAZON_BEDROCK_CLAUDE_3_5_HAIKU,
    provider: ChatModelProviders.AMAZON_BEDROCK,
    enabled: true,
    isBuiltIn: true,
  },
  {
    name: ChatModels.AMAZON_BEDROCK_NOVA_LITE,
    provider: ChatModelProviders.AMAZON_BEDROCK,
    enabled: true,
    isBuiltIn: true,
  },
  {
    name: ChatModels.AMAZON_BEDROCK_NOVA_PRO,
    provider: ChatModelProviders.AMAZON_BEDROCK,
    enabled: true,
    isBuiltIn: true,
  },
